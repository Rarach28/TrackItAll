function pingpoliColorSelector( parent , options )
{
    ...
    if ( document.getElementById("pingpoliColorSelectorStyle") === null )
    {
        ...
        style.innerHTML = "pingpoliColorSelectorContainer{display:grid;grid-template-columns:repeat(8,1fr);position:absolute;left:0;top:0;z-index:999;padding:5px;background-color:#eeeeee;border:1px solid #dddddd;}pingpoliColorSelectorColor{display:inline-block;width:30px;height:30px;margin:5px;border:1px solid #000000;}pingpoliColorSelectorColor:hover{box-shadow:0 0 10px #555555;}";
...
pingpoliColorSelector.prototype.setColor = function( color )
{
    ...
    this.parent.style.color = color;//FIXME
