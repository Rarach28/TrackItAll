...
var jsc = {
	...
	pub : function (targetElement, opts) {
		...
		this.padding = 12; // px
		this.backgroundColor = '#333'; // CSS color
		...
		this.exposeColor = function (flags) {
			...
			if (!(flags & jsc.flags.leavePreview) && this.previewElement) {
				...
				// this.setPreviewElementBg(this.toRGBAString());//FIXME
			}
		...
		function drawPicker () {
			...
			p.btnT.innerHTML = '<input class="text-light" placeholder="mee" />';
